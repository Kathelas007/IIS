                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('hotels.add') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="oznaceni" type="text"
                                           class="form-control @error('oznaceni') is-invalid @enderror" name="oznaceni"
                                           value="{{ old('oznaceni') }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="stat" type="text"
                                           class="form-control @error('stat') is-invalid @enderror" name="stat"
                                           value="{{ old('stat') }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="mesto" type="text"
                                           class="form-control @error('mesto') is-invalid @enderror" name="mesto"
                                           value="{{ old('mesto') }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="ulice" type="text"
                                           class="form-control @error('ulice') is-invalid @enderror" name="ulice"
                                           value="{{ old('ulice') }}" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="c_popisne" type="text"
                                           class="form-control @error('c_popisne') is-invalid @enderror"
                                           name="c_popisne" value="{{ old('c_popisne') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input id="PSC" type="text" class="form-control @error('PSC') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <textarea id="popis" type="text"
                                              class="form-control @error('popis') is-invalid @enderror"
                                              name="popis">{{ old('popis') }}</textarea>
