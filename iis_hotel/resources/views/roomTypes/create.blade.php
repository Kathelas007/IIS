    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('roomTypes.create', $hotel) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <input id="beds_count" type="text" class="form-control @error('beds_count') is-invalid @enderror" name="beds_count" value="{{ old('beds_count') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <textarea id="equipment" type="text" class="form-control @error('equipment') is-invalid @enderror" name="equipment">{{ old('equipment') }}</textarea>
